(function () {
    ...
    angular
        .module('hdl.answer')
        .controller('AnswerPreviewModalController', AnswerPreviewModalController);

    AnswerPreviewModalController.$inject = ['answerData', 'lncMediaService', '$timeout', 'answerService'];

    function AnswerPreviewModalController(answerData, lncMediaService, $timeout, answerService) {
        var vm = this;
        vm.addText = addText;
        ...
        function loadAnswer(){
            ...
            answerService.read(2, 5).then(function(data){
               console.log(data);
            });
        }
        function save() {
